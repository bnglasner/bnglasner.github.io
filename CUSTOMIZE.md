...
> **Repo note:** This file is upstream `al-folio` reference material. For this site, the repo-local source-of-truth and maintenance workflow are documented in [`README.md`](README.md).
