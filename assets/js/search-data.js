...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "Complete publication record, grouped into peer-reviewed publications, working papers, reports, and short-form policy writing.",
          section: "Navigation",
          handler: () => {
          ...
          title: "repositories",
          description: "Selected repositories with concise project snippets and links.",
          section: "Navigation",
          handler: () => {
